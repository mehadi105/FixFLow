            ...
            <div class="grid items-center gap-16 lg:grid-cols-2 lg:gap-12">
                <div class="text-center lg:text-left">
                    ...
                    <div data-hero-item class="ff-hero-delay-4 mt-10 flex flex-col items-center gap-4 sm:flex-row lg:justify-start">
                        @auth
                            <a href="{{ route(auth()->user()->dashboardRoute()) }}" class="ff-btn-primary group w-full sm:w-auto">
                                Go to Dashboard
                            ...
                            <form method="POST" action="{{ route('logout') }}" class="w-full sm:w-auto">
                                @csrf
                                <button type="submit" class="ff-btn-secondary w-full">Log out</button>
                            </form>
                        @else
                ...
                <div data-hero-preview class="relative mx-auto w-full max-w-xl lg:max-w-none">
                    ...
                    <div class="ff-float-badge absolute -left-6 top-[18%] hidden rounded-2xl border border-white/80 bg-white/95 px-4 py-3 shadow-xl backdrop-blur sm:block">
                        <div class="flex items-center gap-2">
