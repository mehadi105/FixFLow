...
@php
    $styles = match(strtolower($status)) {
        ...
        'quoted' => 'bg-fuchsia-50 text-fuchsia-800 ring-fuchsia-500/20',
        ...
        'declined' => 'bg-rose-50 text-rose-800 ring-rose-500/20',
        ...
        'awaiting invoice' => 'bg-amber-50 text-amber-800 ring-amber-500/20',
        'awaiting payment' => 'bg-amber-50 text-amber-800 ring-amber-500/20',
        'awaiting choice' => 'bg-violet-50 text-violet-800 ring-violet-500/20',
        'ready for pickup' => 'bg-sky-50 text-sky-800 ring-sky-500/20',
        'out for delivery' => 'bg-indigo-50 text-indigo-800 ring-indigo-500/20',
        'fulfilled' => 'bg-emerald-50 text-emerald-800 ring-emerald-500/20',
