...
<body class="min-h-screen font-sans antialiased">
    <div class="flex min-h-screen">
        {{-- Brand panel: stick to viewport so long forms don't push welcome text down --}}
        <div class="relative hidden w-1/2 overflow-hidden ff-mesh-dark lg:sticky lg:top-0 lg:flex lg:h-screen lg:flex-col lg:p-12">
            <div class="ff-hero-glow"></div>
            <a href="{{ url('/') }}" class="relative z-10 flex shrink-0 items-center gap-3">
            ...
            <div class="relative z-10 my-auto max-w-md py-8">
            ...
            <p class="relative z-10 shrink-0 text-sm text-slate-500">&copy; {{ date('Y') }} FixFlow</p>
        </div>
